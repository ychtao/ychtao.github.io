...
**Research Interests**: My current research interests are **interactive and data-centric AI/ML** with an emphasis on faithful evaluation and effort-light approaches with applications in chemistry, biology, physics, etc. My past explorations lay in the intersection of machine learning, data mining, and natural language processing.
